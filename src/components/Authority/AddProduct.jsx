        ...
        <Container maxW="container.lg" py={8}>
            <Card variant="outline" mb={8} boxShadow="sm">
                <CardHeader bg="red.50">
                    <Heading size="lg" color="red.600">Add New Product</Heading>
                </CardHeader>
                <CardBody>
                    {/* Image Upload Section */}
                    <Box bg="gray.50" p={6} borderRadius="md" mb={8} border="1px" borderColor="gray.200">
                        <Heading size="md" mb={4} color="red.600">Upload Images</Heading>
                                    ...
                                    <Card key={index} variant="outline">
                                        <CardBody>
                                            <HStack justify="space-between" mb={2}>
                                                <Text fontWeight="medium" color="gray.700">Color Variant {index + 1}</Text>
                                                {index > 0 && (
                                                    <IconButton
                                                        icon={<DeleteIcon />}
                                                        size="sm"
                    ...
                    <form onSubmit={handleSubmit}>
                        <VStack spacing={6} align="stretch">
                            <Box bg="gray.50" p={6} borderRadius="md" border="1px" borderColor="gray.200">
                                <Heading size="md" mb={6} color="red.600">Basic Information</Heading>
                                <VStack spacing={6}>
                            ...
                            <Box bg="gray.50" p={6} borderRadius="md" border="1px" borderColor="gray.200">
                                <Heading size="md" mb={6} color="red.600">Item Sets</Heading>
                                <VStack spacing={4}>
                            ...
                            <Box bg="gray.50" p={6} borderRadius="md" border="1px" borderColor="gray.200">
                                <Heading size="md" mb={6} color="red.600">Product Description</Heading>
                                <FormControl isRequired>
                                    <Textarea
                                        name="description"
