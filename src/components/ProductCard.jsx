...
>
  <Box position="relative" h={{ base: "450px", md: "600px", lg: "700px" }}>
    <Image
...
<Stack spacing={{ base: 1, md: 2 }} boxShadow="lg" p={{ base: 2, md: 6 }}>
  {/* Article Name */}
  <Box boxShadow="sm">
    ...
    <Flex align="center" gap={4}>
      ...
      <Menu w="full">
        <MenuButton
          ...
          boxShadow="sm"
        >
          {selectedSize.size ? `${selectedSize.size} (${selectedSize.lengths} pieces)` : 'Select Size'}
        </MenuButton>
        <MenuList>
  ...
  <Button
    ...
    animation={isAddingToCart ? `${addToCartAnimation} 0.3s ease` : "none"}
    boxShadow="lg"
  >
    Add to Cart
  </Button>
